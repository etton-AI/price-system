...
// 渠道代码 → 统一维度映射
const CHANNEL_META = {
  A1: { speed_tier: "12-15日达", vessel_config: "美森MATSON CLX(正班)", delivery_method: "海派(快递派)" },
  A2: { speed_tier: "12-15日达", vessel_config: "美森MATSON MAX(加班)", delivery_method: "海派(快递派)" },
  ...
  B1: { speed_tier: "12-15日达", vessel_config: "美森MATSON CLX(正班)", delivery_method: "卡派(拆派)" },
  B2: { speed_tier: "12-15日达", vessel_config: "美森MATSON MAX(加班)", delivery_method: "卡派(拆派)" },
  ...
  B8_CLX: { speed_tier: "12-15日达", vessel_config: "美森MATSON CLX(正班)", delivery_method: "海外仓自提" },
  B8_MAX: { speed_tier: "12-15日达", vessel_config: "美森MATSON MAX(加班)", delivery_method: "海外仓自提" },
