...
const { parseNiuku } = require("./niuku");
const { parseBochuangxing } = require("./bochuangxing");
const { parseHYE } = require("./hye");
    ...
    try {
      switch (supplier) {
        ...
        case "ruiqiu":
          ...
          break;
        case "niuku":
          results = parseNiuku(filePath);
          break;
        case "bochuangxing":
          results = parseBochuangxing(filePath);
          break;
        case "hye":
          results = parseHYE(filePath);
          break;
      }
    } catch (err) {
